<div class="space-y-4">
    ...
    <div class="relative bg-red-950/80 rounded-2xl p-4 sm:p-6 border-2 border-red-800/80 min-h-[140px] flex flex-col items-center justify-center space-y-3">
        ...
        <!-- Info Pill Banner -->
        <div class="bg-white text-blue-700 px-8 sm:px-10 py-2 rounded-2xl font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-lg border border-gray-200">
