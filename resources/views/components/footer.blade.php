<footer class="w-full bg-red-950 border-t border-red-900 py-6 px-4 text-center space-y-4 mt-8">
    <div class="flex flex-wrap justify-center gap-4 text-xs font-bold text-red-200 tracking-wider">
        <a href="#how-it-works" class="hover:text-yellow-300">DICE ROLLER</a>
        <span>•</span>
        <a href="#how-it-works" class="hover:text-yellow-300">COLOR DICE</a>
        <span>•</span>
        <a href="#how-it-works" class="hover:text-yellow-300">WHAT ARE DICE?</a>
        <span>•</span>
